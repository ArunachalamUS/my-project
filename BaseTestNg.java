...
public  class BaseTestNg {
	...
	@Test(dependsOnMethods = "launch_bigbasket" )
	private  void Search_btn() {
	   WebElement element = driver.findElement(By.xpath("(//input[@placeholder=\"Search for Products...\"])[2]"));
	...
	private void add2cart_btn() throws InterruptedException  {
		...
		WebElement login = driver.findElement(By.id("multiform"));
		login.sendKeys("6382113738");
